...
func Handler1[
	...
	handler func(context.Context, Environ, T1) error,
	v1 V1,
) Handler {
	return func(ctx context.Context, env Environ) error {
		return handler(ctx, env, v1.Value())
	}
}
...
// Handler3 adapts a func(Context, Environ, T1, T2, T3) for (*command).Runs.
func Handler3[
	T1 any, V1 Param[T1],
	T2 any, V2 Param[T2],
	T3 any, V3 Param[T3],
](
	handler func(context.Context, Environ, T1, T2, T3) error,
	v1 V1, v2 V2, v3 V3,
) Handler {
	return func(ctx context.Context, env Environ) error {
		return handler(ctx, env, v1.Value(), v2.Value(), v3.Value())
	}
}
...
func Handler4[
	...
	handler func(context.Context, Environ, T1, T2, T3, T4) error,
	v1 V1, v2 V2, v3 V3, v4 V4,
) Handler {
	return func(ctx context.Context, env Environ) error {
		return handler(ctx, env, v1.Value(), v2.Value(), v3.Value(), v4.Value())
	}
}
...
func Handler5[
	...
	handler func(context.Context, Environ, T1, T2, T3, T4, T5) error,
	v1 V1, v2 V2, v3 V3, v4 V4, v5 V5,
) Handler {
	return func(ctx context.Context, env Environ) error {
		return handler(ctx, env, v1.Value(), v2.Value(), v3.Value(), v4.Value(), v5.Value())
	}
}
...
// Handler7 adapts a func(Context, Environ, T1...T7) for (*command).Runs.
func Handler7[
	T1 any, V1 Param[T1],
	T2 any, V2 Param[T2],
	T3 any, V3 Param[T3],
	...
	handler func(context.Context, Environ, T1, T2, T3, T4, T5, T6, T7) error,
	v1 V1, v2 V2, v3 V3, v4 V4, v5 V5, v6 V6, v7 V7,
) Handler {
	return func(ctx context.Context, env Environ) error {
		return handler(ctx, env, v1.Value(), v2.Value(), v3.Value(), v4.Value(), v5.Value(), v6.Value(), v7.Value())
	}
}
